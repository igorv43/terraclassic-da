...
// 	resp, err := http.Post("http://localhost:1317/txs", "application/json", bytes.NewReader(txJSON))
// 	if err != nil {
...
//     )
// 	if err != nil {
// 		fmt.Println("failed to BroadcastTx message: ", err)
...
// 	if err != nil {
// 		fmt.Println("failed to marshal TxResponseBytes message: ", err)
// 		return submitrequest,err
// 	}
