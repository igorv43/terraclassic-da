module github.com/igorv43/terraclassic-da
...
replace (
	//
	github.com/gogo/protobuf v1.3.3 => github.com/regen-network/protobuf v1.3.1
	github.com/regen-network/protobuf => github.com/gogo/protobuf v1.3.2
